...
class AdminController extends GlobalController
{
    ...
    public function index(){
        ...
        } else if((Auth::guard('admin')->user()->role_id == '11' || Auth::guard('admin')->user()->role_id == '12') && (Auth::guard('admin')->user()->location_id != '0')){
            $totalCompleted = StudySchedule::where('is_active', 1)
                                            ->where('is_delete', 0)
                                            ->where('activity_status', 'COMPLETED')
                                            ->where('scheduled_start_date', '!=', NULL)
        ...
        } else if((Auth::guard('admin')->user()->role_id == '13') || ((Auth::guard('admin')->user()->role_id == '15') && (Auth::guard('admin')->user()->location_id != '0'))){
            $totalCompleted = StudySchedule::where('is_active', 1)
                                            ->where('is_delete', 0)
                                            ->where('activity_status', 'COMPLETED')
                                            ->where('scheduled_start_date', '!=', NULL)
        ...
        } else if((Auth::guard('admin')->user()->role_id == '15') && (Auth::guard('admin')->user()->location_id == '0')){
            $totalCompleted = StudySchedule::where('is_active', 1)
                                            ->where('is_delete', 0)
                                            ->where('activity_status', 'COMPLETED')
                                            ->where('scheduled_start_date', '!=', NULL)
        ...
        } else if((Auth::guard('admin')->user()->role_id == '11') && (Auth::guard('admin')->user()->location_id == '0')){
            $totalCompleted = StudySchedule::where('is_active', 1)
                                            ->where('is_delete', 0)
                                            ->where('activity_status', 'COMPLETED')
                                            ->where('scheduled_start_date', '!=', NULL)
